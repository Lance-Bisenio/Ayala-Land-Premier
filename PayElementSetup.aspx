<%@ Page Title="" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeFile="PayElementSetup.aspx.vb" Inherits="PayElementSetup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="container-fluid">
            ...
            <div class="col-sm-12">
                <div class="col-sm-6">
                    <div class="btn-group">
                        ...
                        <%--<button type="button" id="BtnCalculate" runat="server" class="btn btn-primary btn-sm">Calculate</button>--%>
        ...
        <div class="row">
                ...
                <div class="table-responsive">
                    <asp:GridView ID="TblRecurringList" runat="server" AllowPaging="True" BorderColor="#CCCCCC" Font-Size="Small"
                        ...
                        <Columns>
                            ...
                            <%--<asp:BoundField DataField="BatchNo" HeaderText="BatchNo" HeaderStyle-CssClass="hideGridColumn"
                            ...
                            <asp:BoundField DataField="TotalAmt" HeaderText="Amount">
                                <ItemStyle CssClass="labelL" />
                            </asp:BoundField>
            ...
            <div class="col-sm-8">
                <div class="table-responsive">
                    <asp:GridView ID="TblDetails" runat="server" AllowPaging="True" BorderColor="#CCCCCC" Font-Size="Small"
                        AutoGenerateColumns="False" Width="100%" BorderStyle="Solid" BorderWidth="1px"
                        CssClass="table table-sm table-bordered table-striped" PageSize="15" EnableModelValidation="True"
                        SelectedRowStyle-CssClass="btn btn-info">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="OldRate" HeaderText="Rate">
                                <ItemStyle CssClass="labelL" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="DateDiff" HeaderText="Day Diff">
                    ...
                    <small class="text-info">Release Formula: (Amount / 2 / 15 * DayDiff)</small><br />
                    <small class="text-info">Adjust Formula: (Amount / 2 / 15 * DayDiff) - (Rate / 2 / 15 * DayDiff)</small>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <small>Enter user remarks:</small>
                            <div class="form-inline">
                                <asp:TextBox ID="TxtUserRemarks" runat="server" CssClass="form-control form-control-sm col-12" Placeholder=""></asp:TextBox>
                            </div>
                        </div>
                    </div>
